...
class PyExpr:
    ...
    def first_value(self, ignore_nulls: bool) -> PyExpr: ...
    def last_value(self, ignore_nulls: bool) -> PyExpr: ...
...
class PyMicroPartition:
    ...
    @staticmethod
    def from_arrow_stream(obj: Any) -> PyMicroPartition: ...
    @staticmethod
...
class FlightPartitions:
    def __init__(self, partitions: list[FlightPartitionRef]) -> None: ...
    @property
    def partitions(self) -> list[FlightPartitionRef]: ...
...
class PyResultReceiver:
    ...
    async def __anext__(self) -> PyMicroPartition | FlightPartitions | None: ...
...
def get_loaded_extension_paths() -> list[str]: ...
