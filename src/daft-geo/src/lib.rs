...
pub use st_dump::StDump;
pub use st_dumprings::StDumpRings;
pub use st_dwithin::StDwithin;
...
impl FunctionModule for SpatialFunctions {
    fn register(parent: &mut daft_dsl::functions::FunctionRegistry) {
        ...
        parent.add_fn(StDump);
        parent.add_fn(StDumpRings);
        parent.add_fn(StDwithin);
        ...
        parent.add_fn(StPoint);
        parent.add_fn(StMakeLine);
        parent.add_fn(StBbox);
